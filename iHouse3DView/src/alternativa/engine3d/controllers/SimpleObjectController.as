...
package alternativa.engine3d.controllers {
	...
	public class SimpleObjectController {
		...
		public var objectTransform:Vector.<Vector3D>;
		 ...
		 */
		public function SimpleObjectController(pWnd:iHouse3DView, eventSource:InteractiveObject, object:Object3D, speed:Number, speedMultiplier:Number = 3, mouseSensitivity:Number = 1) {
		...
		public function disableKey():void {
			eventSource.removeEventListener(KeyboardEvent.KEY_DOWN, onKey);
			eventSource.removeEventListener(KeyboardEvent.KEY_UP, onKeyUP);
		}		
		...
		public function update():void {
			...
			if (mouseLook) {
				var dx:Number = (eventSource.mouseX - mousePoint.x)/10;		// chen
				var dy:Number = (eventSource.mouseY - mousePoint.y)/10;		// chen	
		...
		//		var dy:Number = eventSource.mouseY - mousePoint.y;
			...
			//	if(gMain.mSetting.m_cCamera.selected == true )
