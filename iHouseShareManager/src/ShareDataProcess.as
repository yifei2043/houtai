...
package 
{
	...
	public class ShareDataProcess
	{
		public var m_iHouse:iHouseShareManager = null;
		...
		public function ShareDataProcess(iHouse:iHouseShareManager)
		{
			m_iHouse = iHouse;
	...
	//			m_iHouse3DView.mAlertDialog.show(error.toString());
		...
		{  
			...
			m_iHouse.mImageView.downloadImage();
			m_iHouse.mImageView.UpdateProject();	
		}
